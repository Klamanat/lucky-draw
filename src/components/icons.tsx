// Chinese New Year themed SVG icons

export function LanternIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8 13C8 13 9 11 12 11C15 11 16 13 16 13" stroke="white" strokeOpacity="0.3" strokeWidth="1"/>
      <rect x="8" y="6" width="8" height="2" rx="1" fill="#FFD700"/>
      <rect x="8" y="18" width="8" height="1.5" rx="0.5" fill="#FFD700"/>
      <path d="M12 19.5V22" stroke="#FFD700" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="12" cy="22.5" r="1" fill="currentColor"/>
    </svg>
  );
}

export function RedEnvelopeIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="3" width="16" height="18" rx="2" fill="currentColor"/>
      <rect x="4" y="3" width="16" height="6" rx="2" fill="currentColor" opacity="0.8"/>
      <circle cx="12" cy="9" r="4" fill="#FFD700"/>
      <circle cx="12" cy="9" r="2.5" fill="currentColor"/>
      <path d="M11 8.5L12 10L13 8.5" stroke="#FFD700" strokeWidth="0.5"/>
      <rect x="6" y="14" width="12" height="1" rx="0.5" fill="#FFD700" opacity="0.3"/>
      <rect x="6" y="16.5" width="8" height="1" rx="0.5" fill="#FFD700" opacity="0.3"/>
    </svg>
  );
}
...
export function SaveIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CoinIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="12" cy="12" r="7" stroke="#8B0000" strokeWidth="1" fill="none"/>
      <rect x="10" y="6" width="4" height="2" rx="0.5" fill="#8B0000"/>
      <rect x="10" y="16" width="4" height="2" rx="0.5" fill="#8B0000"/>
      <rect x="11" y="8" width="2" height="8" fill="#8B0000"/>
    </svg>
  );
}

export function FortuneIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none"/>
      <text x="12" y="16" textAnchor="middle" fill="currentColor" fontSize="10" fontWeight="bold" fontFamily="serif">福</text>
    </svg>
  );
}
...
export function SpinIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
